                ...
                <div className="pt-10 mx-auto">
                    <div className="lg:grid lg:grid-cols-6 gap-20">
                        <div className="col-span-3">
                            <div className="flex items-center space-x-5">
                                <img src="https://cdn.discordapp.com/avatars/1216390143775211530/faaf62d04e326108b6779667fa939e12.webp" className="rounded-full w-12" />
                                <p className="font-semibold text-xl text-white">KaraNitro Bot</p>
                            </div>
                            <Menu as="div" className="relative mt-3 inline-block text-left">
                                <div>
                                    <Menu.Button className="flex z-1 items-center w-full px-4 py-2 text-sm font-medium text-white bg-black rounded-md bg-opacity-20 hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75">
                                        <img
                                            src={`https://cdn.discordapp.com/attachments/1198720669031084153/1216750016140546108/hD9nYL0sQXIOpAAAAAElFTkSuQmCC.png?ex=660185c1&is=65ef10c1&hm=81d8ad656e07dd480dfaf4e495824efb81a51279b0cd72a0f6dda186cc71384c&`}
                                            width="24"
                                            height="18"
                        ...
                        <div className="col-span-1">
                            ...
                            <div>
                                <a href="https://discord.gg/HyTUJmgg2v" target="_blank" className="text-white/50 hover:text-white hover:underline transform duration-200">
                                    Destek Sunucusu
                                </a>
                            </div>
                            <div>
                    ...
                    <div className="mt-10 grid content-center grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
                        <p className="text-white text-center sm:text-left text-opacity-50">
                            {new Date().getFullYear()} &copy; KaraNitro Bot
                        </p>
