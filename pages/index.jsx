...
export default function Index() {
  ...
  return (
    <>
      ...
      <img width="500" src="/img/bck.png" />
       ...
       KaraNitro botu ile sunucunuzu yönetmeye ne dersiniz? Sende KaraNitro'yu ekle ve kullanmaya başla.  
	  </p>
        <div className="animateHeader mt-10 flex flex-wrap items-center justify-center gap-x-4">
  
            <Link href={"https://discord.com/api/oauth2/authorize?client_id=1216390143775211530&permissions=8&scope=bot"}>
              <a
                className={
  ...
  <Link href={"https://top.gg/bot/1216390143775211530/vote"}>
          ...
          <div className="col-span-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div>
                <div className="text-white">
                  <p className="text-xl font-semibold mt-5"><i className={`fa fa-cogs text-2xl text-amber-500`} /> Görevleri</p>
                  <p className="text-gray-500 line-clamp-4">Bİr sunucu için ne komut gerekiyorsa hepsi vardır.</p>
                </div>
              </div>
              <div>
                <div className="text-white">
                  <p className="text-xl font-semibold mt-5"><i className={`fa fa-universal-access text-2xl text-amber-500`} /> Evrensel</p>
                  <p className="text-gray-500 line-clamp-4">Botu herkes kullana bilir. Herhangi bir ücreti yoktu ve olmayacaktırda.)</p>
                </div>
              </div>
              <div>
                <div className="text-white">
      ...
      <div className="flex flex-row w-full h-auto lg:h-56 my-14 lg:my-40 bg-gradient-to-br lg:px-30 from-neutral-900/90 flex items-center justify-start to-neutral-900/50 rounded-lg p-1 shadow-md">
              <>
                <div className="lg:mx-4 lg:p-8 py-4 lg:py-16 flex items-center justify-center flex-col text-center w-full lg:w-auto lg:text-left lg:flex-none">
                  ...
                  <p className="text-md text-white font-medium text-gray-500 line-clamp-5">Are you ready to throw the best parties with Kara Nitro, the best and most up-to-date bot?</p>
                </div>
                <img src="https://cdn.discordapp.com/avatars/121639https://cdn.discordapp.com/avatars/1216390143775211530/faaf62d04e326108b6779667fa939e12.png0143775211530/faaf62d04e326108b6779667fa939e12.png" className="hidden lg:block rounded-xl perspective-right shadow-xl shadow-black" />
              </>
